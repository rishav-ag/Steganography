...
function uploadMultipleFiles(files) {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/upload-multiple-files");
...
function downloadStegoFile() {
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/download-stego-file");
    ...
    xhr.onload = function() {
        ...
        if(xhr.status == 200) {
            ...
            fileDownloadSuccess.innerHTML = "<p>Encrypted File: .</p><p>DownloadUrl : <a href='" + response.fileDownloadUri + "' target='_blank'>" + response.fileDownloadUri + "</a></p>";
