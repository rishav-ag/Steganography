...
public class FileStorageController {
	...
	@PostMapping("/download-stego-file")
	public UploadFileResponse downloadFile(HttpServletRequest request) {
		imageSteganography.encode();
		String fileName = "stego.png";
	...
	@PostMapping("/download-decrypted-file")
	public UploadFileResponse getDecryptedFile(HttpServletRequest request) {
